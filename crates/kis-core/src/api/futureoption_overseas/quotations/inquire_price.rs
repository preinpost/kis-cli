//! 해외선물종목현재가 — GET /uapi/overseas-futureoption/v1/quotations/inquire-price
//!
//! 스펙: .agent/specs/futureoption_overseas__quotations__inquire_price.md
...
pub const ENDPOINT: &str = "/uapi/overseas-futureoption/v1/quotations/inquire-price";
pub const TR_ID: &str = "HHDFC55010000";
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("해외선물종목현재가는 모의투자 미지원 API입니다");
    }
