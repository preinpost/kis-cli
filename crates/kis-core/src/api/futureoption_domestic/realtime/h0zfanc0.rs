//! 주식선물 실시간예상체결 — WebSocket /tryitout/H0ZFANC0
//!
//! 스펙: .agent/specs/futureoption_domestic__realtime__h0zfanc0.md
//! 실시간 WebSocket API. 모의투자 미지원.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0ZFANC0";
