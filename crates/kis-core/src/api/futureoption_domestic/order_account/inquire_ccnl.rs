//! 선물옵션 주문체결내역조회 — GET /uapi/domestic-futureoption/v1/trading/inquire-ccnl
//!
//! 스펙: .agent/specs/futureoption_domestic__order_account__inquire_ccnl.md
...
pub const ENDPOINT: &str = "/uapi/domestic-futureoption/v1/trading/inquire-ccnl";
pub const TR_ID_REAL: &str = "TTTO5201R";
pub const TR_ID_MOCK: &str = "VTTO5201R";
