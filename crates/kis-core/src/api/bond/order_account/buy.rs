//! 장내채권 매수주문 — POST /uapi/domestic-bond/v1/trading/buy
//!
//! 스펙: .agent/specs/bond__order_account__buy.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-bond/v1/trading/buy";
pub const TR_ID: &str = "TTTC0952U";
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("장내채권 매수주문은 모의투자 미지원 API입니다");
    }
