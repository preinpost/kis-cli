//! 종목별 외국계 순매수추이 — GET /uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend";
pub const TR_ID: &str = "FHKST644400C0";
