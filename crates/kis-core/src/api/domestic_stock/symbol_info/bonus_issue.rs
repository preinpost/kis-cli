//! 예탁원정보(무상증자일정) — GET /uapi/domestic-stock/v1/ksdinfo/bonus-issue
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ksdinfo/bonus-issue";
pub const TR_ID: &str = "HHKDB669101C0";
