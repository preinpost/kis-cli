//! 예탁원정보(상장정보일정) — GET /uapi/domestic-stock/v1/ksdinfo/list-info
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ksdinfo/list-info";
pub const TR_ID: &str = "HHKDB669107C0";
