...
//!
//! 스펙: .agent/specs/domestic_stock__ranking__market_value.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/market-value";
pub const TR_ID: &str = "FHPST01790000";
...
pub struct Row {
    ...
    pub ebitda: String,
    #[serde(default)]
    pub pv_div_ebitda: String,
    #[serde(default)]
    pub ebitda_div_fnnc_expn: String,
    #[serde(default)]
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Vec<Row>> {
    if client.is_mock() {
        bail!("국내주식 시장가치 순위는 모의투자 미지원 API입니다");
    }
    let params = [
