//! 국내주식 우선주/괴리율 상위 — GET /uapi/domestic-stock/v1/ranking/prefer-disparate-ratio
//!
//! 스펙: .agent/specs/domestic_stock__ranking__prefer_disparate_ratio.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/prefer-disparate-ratio";
pub const TR_ID: &str = "FHPST01770000";
...
pub struct Row {
    ...
    pub acml_vol: String,
    #[serde(default)]
    pub prst_iscd: String,
    #[serde(default)]
    pub prst_kor_isnm: String,
    #[serde(default)]
    pub prst_prpr: String,
    #[serde(default)]
    pub prst_prdy_vrss: String,
    #[serde(default)]
    pub prst_prdy_vrss_sign: String,
    #[serde(default)]
    pub prst_acml_vol: String,
    #[serde(default)]
    pub diff_prpr: String,
    #[serde(default)]
    pub dprt: String,
    #[serde(default)]
    pub prdy_ctrt: String,
    #[serde(default)]
    pub prst_prdy_ctrt: String,
}

pub async fn call(client: &KisClient, req: &Request) -> Result<Vec<Row>> {
    if client.is_mock() {
        bail!("국내주식 우선주/괴리율 상위는 모의투자 미지원 API입니다");
    }
    let params = [
