//! 국내주식 시간외잔량 순위 — GET /uapi/domestic-stock/v1/ranking/after-hour-balance
//!
//! 스펙: .agent/specs/domestic_stock__ranking__after_hour_balance.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/after-hour-balance";
pub const TR_ID: &str = "FHPST01760000";
...
pub struct Row {
    ...
    #[serde(default)]
    pub mkob_otcp_vol: String,
    #[serde(default)]
    pub mkfa_otcp_vol: String,
}

pub async fn call(client: &KisClient, req: &Request) -> Result<Vec<Row>> {
    if client.is_mock() {
        bail!("국내주식 시간외잔량 순위는 모의투자 미지원 API입니다");
    }
    let params = [
