//! 국내주식 실시간체결가 (NXT) — WebSocket /tryitout/H0NXCNT0
//!
//! 스펙: .agent/specs/domestic_stock__realtime__h0nxcnt0.md
//! 실시간 WebSocket API. 모의투자 미지원. NXT 시장 체결가.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0NXCNT0";
