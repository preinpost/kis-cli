//! 국내주식 실시간체결가 (통합) — WebSocket /tryitout/H0UNCNT0
//!
//! 스펙: .agent/specs/domestic_stock__realtime__h0uncnt0.md
//! 실시간 WebSocket API. 모의투자 미지원. KRX+NXT 통합 체결가.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0UNCNT0";
