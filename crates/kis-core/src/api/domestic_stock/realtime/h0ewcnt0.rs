//! ELW 실시간체결가 — WebSocket /tryitout/H0EWCNT0
//!
//! 스펙: .agent/specs/domestic_stock__realtime__h0ewcnt0.md
//! 실시간 WebSocket API. 모의투자 미지원.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0EWCNT0";
...
pub fn parse_frame(data: &str) -> Result<Response> {
    ...
    if f.len() < 64 {
        return Err(anyhow!("필드 수 부족: {} < 64", f.len()));
    }
    ...
    Ok(Response {
        ...
        hts_thpr: g(55),
        vol_tnrt: g(56),
        prdy_smns_hour_acml_vol: g(57),
        prdy_smns_hour_acml_vol_rate: g(58),
        apprch_rate: g(59),
        lp_hvol: g(60),
        lp_hldn_rate: g(61),
        lp_ntby_qty: g(62),
