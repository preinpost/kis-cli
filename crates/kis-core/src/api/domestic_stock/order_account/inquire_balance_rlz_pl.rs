//! 주식잔고조회_실현손익 — GET /uapi/domestic-stock/v1/trading/inquire-balance-rlz-pl
//!
//! 스펙: .agent/specs/domestic_stock__order_account__inquire_balance_rlz_pl.md
//!
//! 모의투자 미지원. output1(Holdings) + output2(Summary + 실현손익).
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/trading/inquire-balance-rlz-pl";
pub const TR_ID: &str = "TTTC8494R";
...
pub struct Summary {
    ...
    #[serde(default)]
    pub real_evlu_pfls: String,
    #[serde(default)]
    pub real_evlu_pfls_erng_rt: String,
}
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("주식잔고조회_실현손익은 모의투자 미지원 API입니다");
    }
    let params = [
        ...
        ("COST_ICLD_YN", req.cost_icld_yn.as_str()),
