//! (야간)선물옵션 잔고현황 — GET /uapi/domestic-futureoption/v1/trading/inquire-ngt-balance
//!
//! 스펙: .agent/specs/futureoption_domestic__order_account__inquire_ngt_balance.md
//! 모의투자 미지원. 신 TR_ID `CTFN6118R` 사용.
...
pub const ENDPOINT: &str = "/uapi/domestic-futureoption/v1/trading/inquire-ngt-balance";
pub const TR_ID: &str = "CTFN6118R";
...
pub struct Summary {
    ...
    #[serde(default)]
    pub mmga_tot_amt: String,
    #[serde(default)]
    pub mmga_cash_amt: String,
    #[serde(default)]
    pub mtnc_rt: String,
    #[serde(default)]
    pub isfc_amt: String,
