//! 지수옵션 실시간체결가 — WebSocket /tryitout/H0IOCNT0
//!
//! 스펙: .agent/specs/futureoption_domestic__realtime__h0iocnt0.md
//! 실시간 WebSocket API. 모의투자 미지원.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0IOCNT0";
...
pub struct Response {
    ...
    pub avrg_vltl: String,
    pub dscs_lrqn_vol: String,
...
pub fn parse_frame(data: &str) -> Result<Response> {
    ...
    if f.len() < 58 {
        return Err(anyhow!("필드 수 부족: {} < 58", f.len()));
    }
