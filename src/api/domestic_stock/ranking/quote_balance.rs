//! 국내주식 호가잔량 순위 — GET /uapi/domestic-stock/v1/ranking/quote-balance
//!
//! 스펙: .agent/specs/domestic_stock__ranking__quote_balance.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/quote-balance";
pub const TR_ID: &str = "FHPST01720000";
...
pub struct Row {
    ...
    #[serde(default)]
    pub total_ntsl_bidp_rsqn: String,
    #[serde(default)]
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Vec<Row>> {
    if client.is_mock() {
        bail!("국내주식 호가잔량 순위는 모의투자 미지원 API입니다");
    }
    let params = [
