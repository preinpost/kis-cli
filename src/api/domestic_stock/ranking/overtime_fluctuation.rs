//! 국내주식 시간외등락율순위 — GET /uapi/domestic-stock/v1/ranking/overtime-fluctuation
//!
//! 스펙: .agent/specs/domestic_stock__ranking__overtime_fluctuation.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/overtime-fluctuation";
pub const TR_ID: &str = "FHPST02340000";
...
pub struct Meta {
    #[serde(default)]
    pub ovtm_untp_uplm_issu_cnt: String,
    #[serde(default)]
    pub ovtm_untp_ascn_issu_cnt: String,
    #[serde(default)]
    pub ovtm_untp_stnr_issu_cnt: String,
    #[serde(default)]
    pub ovtm_untp_lslm_issu_cnt: String,
    #[serde(default)]
    pub ovtm_untp_down_issu_cnt: String,
    #[serde(default)]
    pub ovtm_untp_acml_vol: String,
    #[serde(default)]
    pub ovtm_untp_acml_tr_pbmn: String,
    #[serde(default)]
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("국내주식 시간외등락율순위는 모의투자 미지원 API입니다");
    }
    let params = [
