//! 국내주식 관심종목등록 상위 — GET /uapi/domestic-stock/v1/ranking/top-interest-stock
//!
//! 스펙: .agent/specs/domestic_stock__ranking__top_interest_stock.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/ranking/top-interest-stock";
pub const TR_ID: &str = "FHPST01800000";
...
pub struct Row {
    ...
    #[serde(default)]
    pub inter_issu_reg_csnu: String,
}

pub async fn call(client: &KisClient, req: &Request) -> Result<Vec<Row>> {
    if client.is_mock() {
        bail!("국내주식 관심종목등록 상위는 모의투자 미지원 API입니다");
    }
    let params = [
