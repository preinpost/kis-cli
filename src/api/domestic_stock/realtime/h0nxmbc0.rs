//! 국내주식 실시간회원사 (NXT) — WebSocket /tryitout/H0NXMBC0
//!
//! 스펙: .agent/specs/domestic_stock__realtime__h0nxmbc0.md
//! 실시간 WebSocket API. 모의투자 미지원. NXT 시장 회원사.

use anyhow::{anyhow, Result};
use serde::Deserialize;

pub const TR_ID: &str = "H0NXMBC0";
