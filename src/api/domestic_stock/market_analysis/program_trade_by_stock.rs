//! 종목별 프로그램매매추이(체결) — GET /uapi/domestic-stock/v1/quotations/program-trade-by-stock
...
pub const ENDPOINT: &str = "/uapi/domestic-stock/v1/quotations/program-trade-by-stock";
pub const TR_ID: &str = "FHPPG04650101";
...
pub struct Row {
    ...
    #[serde(default)]
    pub whol_ntby_tr_pbmn_icdc: String,
}
