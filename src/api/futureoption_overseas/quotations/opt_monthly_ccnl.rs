//! 해외옵션 체결추이(월간) — GET /uapi/overseas-futureoption/v1/quotations/opt-monthly-ccnl
//!
//! 스펙: .agent/specs/futureoption_overseas__quotations__opt_monthly_ccnl.md
//! 모의투자 미지원. 최근 120건까지 조회 (START/CLOSE_DATE_TIME 공란 입력).
...
pub const ENDPOINT: &str = "/uapi/overseas-futureoption/v1/quotations/opt-monthly-ccnl";
pub const TR_ID: &str = "HHDFO55020300";
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("해외옵션 체결추이(월간)는 모의투자 미지원 API입니다");
    }
    let params = [
