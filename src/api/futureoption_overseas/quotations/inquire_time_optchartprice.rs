//! 해외옵션 분봉조회 — GET /uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice
//!
//! 스펙: .agent/specs/futureoption_overseas__quotations__inquire_time_optchartprice.md
//! 모의투자 미지원. 스펙 특이: meta가 output2, 배열이 output1.
...
pub const ENDPOINT: &str = "/uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice";
pub const TR_ID: &str = "HHDFO55020400";
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("해외옵션 분봉조회는 모의투자 미지원 API입니다");
    }
    let params = [
