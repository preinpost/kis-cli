//! 해외선물 체결추이(일간) — GET /uapi/overseas-futureoption/v1/quotations/daily-ccnl
//!
//! 스펙: .agent/specs/futureoption_overseas__quotations__daily_ccnl.md
//! 모의투자 미지원.
...
pub const ENDPOINT: &str = "/uapi/overseas-futureoption/v1/quotations/daily-ccnl";
pub const TR_ID: &str = "HHDFC55020100";
...
pub async fn call(client: &KisClient, req: &Request) -> Result<Response> {
    if client.is_mock() {
        bail!("해외선물 체결추이(일간)는 모의투자 미지원 API입니다");
    }
    let params = [
