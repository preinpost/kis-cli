...
- **실전TRID**: FHKST01010400
- **모의TRID**: FHKST01010400
...
| FID_ORG_ADJ_PRC | 수정주가 원주가 가격 | String | Y | 10 | '0 : 수정주가미반영1 : 수정주가반영* 수정주가는 액면분할/액면병합 등 권리 발생 시 과거 시세를 현재 주가에 맞게 보정한 가격' |
