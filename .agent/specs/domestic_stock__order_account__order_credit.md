...
- **모의Domain**: 모의투자 미지원
- **실전TRID**: (매도) TTTC0051U (매수) TTTC0052U
- **모의TRID**: 모의투자 미지원
- **Format**: JSON
...
| tr_id | 거래ID | String | Y | 13 | '※ 구TR은 사전고지 없이 막힐 수 있으므로 반드시 신TR로 변경이용 부탁드립니다.[실전투자]매도 : (구)TTTC0851U → (신)TTTC0051U매수 : (구)TTTC0852U → (신)TTTC0052U' |
