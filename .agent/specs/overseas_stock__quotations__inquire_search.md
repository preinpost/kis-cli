...
- **실전TRID**: HHDFS76410000
- **모의TRID**: HHDFS76410000
- **Format**: JSON
...
| rsym | 실시간조회심볼 | String | N | 32 | 실시간조회심볼D+시장구분(3자리)+종목코드예) DNASAAPL : D+NAS(나스닥)+AAPL(애플)[시장구분]NYS : 뉴욕, NAS : 나스닥, AMS : 아멕스 ,TSE : 도쿄, HKS : 홍콩,SHS : 상해, SZS : 심천HSX : 호치민, HNX : 하노이 |
