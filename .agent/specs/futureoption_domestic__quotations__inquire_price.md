...
- **실전TRID**: FHMIF10000000
- **모의TRID**: FHMIF10000000
...
| tr_id | 거래ID | String | Y | 13 | [실전/모의투자]FHMIF10000000 : 선물 옵션 시세 |
...
| basis | 베이시스 | String | Y | 13 | 이론베이시스선물 이론가격과 현물가격과의 차이 |
...
| dprt | 괴리율 | String | Y | 11 | 현재의 시장가가 이론가격으로부터 얼마나 벗어나 있는지에 대한 측정 자료괴리도 = (현재가 - 이론가격) |
...
| mrkt_basis | 시장 베이시스 | String | Y | 13 | 시장베이시스현재 시장에서 형성된 선물가격과 현물가격과의 차이 |
